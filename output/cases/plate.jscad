function plate_extrude_1_41_outline_fn(){
    return new CSG.Path2D([[81.2839997,-98.114607],[95.231875,-97.8711459]]).appendPoint([94.9884139,-83.9232706]).appendPoint([81.0405386,-84.1667317]).appendPoint([81.2839997,-98.114607]).close().innerToCAG()
.union(
    ...
    new CSG.Path2D([[53.5398033,-206.9198927],[67.4558218,-205.9467898]]).appendPoint([66.4827189,-192.0307713]).appendPoint([52.5667004,-193.0038742]).appendPoint([53.5398033,-206.9198927]).close().innerToCAG()
                ...
                let plate__part_0 = plate_extrude_1_41_outline_fn();
